...
public class edit_game extends UserLogic
{
        ...
        throws Exception
    {
        ...
        if (gameId != 0) {
            game = app.getCardBoxRepository().loadGame(gameId);
            if (game != null) {
                ctx.put("game", game);
            }
        }
        ...
        URL rurl = new URL(CardBoxConfig.getResourceURL());
        ...
        if (action.equals("update")) {
            ...
            app.getCardBoxRepository().updateGame(game);
            ...
            game.host = CardBoxConfig.getServerHost();
            game.digest = "";
            ...
            app.getCardBoxRepository().insertGame(game);
