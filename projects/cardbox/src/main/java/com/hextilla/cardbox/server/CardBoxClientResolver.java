...
/**
 * Customizes the client resolver to use our {@link CardBoxUserObject}.
 */
public class CardBoxClientResolver extends CrowdClientResolver
{
    @Override // from CrowdClientResolver
    public ClientObject createClientObject ()
    {
        return new CardBoxUserObject();
    }
}
