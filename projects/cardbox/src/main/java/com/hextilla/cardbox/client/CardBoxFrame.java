...
/**
 * Contains the user interface for the CardBox client application.
 */
public class CardBoxFrame extends ManagedJFrame
    implements CardBoxClient.Shell
{
    /**
     * Constructs the top-level CardBox client frame with the specified window
     * title.
     */
    public CardBoxFrame (String title, String gameId, String username)
    {
        super(title);
        ...
        Rectangle bounds = CardBoxPrefs.getClientBounds(gameId, username);
        if (bounds != null) {
            setBounds(bounds);
        } else {
            setSize(800, 600);
    ...
    public void addNotify ()
    {
        ...
        addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized (ComponentEvent e) {
                CardBoxPrefs.setClientBounds(_gameId, _username, getBounds());
            }
            @Override
    ...
    public void bindCloseAction (final CardBoxClient client)
    {
