 ...
 */
public class CardBoxRepository extends DepotRepository
    implements CardBoxManager.GameRepository
{
    /**
     * The database identifier used when establishing a database connection. This value being
     * <code>gamedb</code>.
     */
    public static final String GAME_DB_IDENT = "game";

    /**
     * Constructs a new repository with the specified persistence context.
     */
    public CardBoxRepository (PersistenceContext ctx)
    {
        super(ctx);
    }
