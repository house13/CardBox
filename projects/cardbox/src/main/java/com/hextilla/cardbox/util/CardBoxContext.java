...
/**
 * Aggregates the various bits that are needed on the CardBox client.
 */
public abstract class CardBoxContext implements ParlorContext
{
    /**
    ...
    /**
     * Returns a reference to the friend chat director.
     */
    public abstract CardBoxChatDirector getFriendChatDirector ();
     ...
     * Returns a reference to our Social director.
     */
    public abstract InvitationDirector getInvitationDirector ();
    ...
    {
        return getCardBoxDirector().getResourceManager();
    }
